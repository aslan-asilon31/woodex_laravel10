          ...
          <div class="col-lg-12">
            ...
            <div class="btn btn-gradient-primary" style="display: flex;">
              ...
              <select class="form-control " style="width: 100%;" id="exampleFormControlSelect2">
                <option> - </option>
                <option> <a href="">Add Product</a> </option>
                <option> <a href="">Export Excel Product</a> </option>
                <option> <a href="">Import Excel Product</a> </option>
                <option> <a href="">Export CSV Product</a> </option>
                <option> <a href="">Import CSV Product</a> </option>
                <option> <a href="">Export PDF Product</a> </option>
              </select>
            </div>
