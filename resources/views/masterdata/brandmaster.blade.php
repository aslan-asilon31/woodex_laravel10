        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $brand->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($brand->image_banner))
                                <img src="{{ asset('frontend/assets/images/icons/'. $brand->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $brand->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $brand->name }}</td>
