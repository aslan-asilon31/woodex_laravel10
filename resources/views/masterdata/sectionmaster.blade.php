        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $section->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($section->image_banner))
                                <img src="{{ asset('frontend/assets/prices/icons/'. $section->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $section->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $section->name }}</td>
