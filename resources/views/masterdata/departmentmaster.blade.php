        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $department->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($department->image_banner))
                                <img src="{{ asset('frontend/assets/images/icons/'. $department->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $department->image_banner }}</span>
                            @endif
                        </div>
                    </td>
