        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $status->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($status->image_banner))
                                <img src="{{ asset('frontend/assets/prices/icons/'. $status->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $status->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $status->name }}</td>
