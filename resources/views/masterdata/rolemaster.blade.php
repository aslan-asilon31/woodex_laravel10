        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $role->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($role->image_banner))
                                <img src="{{ asset('frontend/assets/prices/icons/'. $role->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $role->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $role->name }}</td>
