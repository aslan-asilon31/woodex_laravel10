        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $image->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($image->image_banner))
                                <img src="{{ asset('frontend/assets/images/icons/'. $image->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $image->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $image->name }}</td>
