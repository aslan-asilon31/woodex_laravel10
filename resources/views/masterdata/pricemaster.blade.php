        ...
        <table class="table table-custom table-lg mb-0" id="customers">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#">{{ $price->bank_master_id }}</a>
                    </td>
                    <td>
                        <div class="avatar avatar-info">
                            @if (!empty($price->image_banner))
                                <img src="{{ asset('frontend/assets/prices/icons/'. $price->image_banner) }}" >
                            @else
                                <span class="avatar-text rounded-circle">{{ $price->image_banner }}</span>
                            @endif
                        </div>
                    </td>
                    <td>{{ $price->name }}</td>
