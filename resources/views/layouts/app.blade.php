...
<head>
  ...
  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-product-1.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-product-2.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-product-3.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-product-4.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-product-5.jpg') }}">
          ...
          <ul class="hero-list">
            ...
            <li>
              <div class="hero-card">
                ...
                <figure class="card-banner img-holder" style="--width: 285; --height: 396;">
                  <img src="{{ asset('frontend/assets/images/hero-product-1.jpg') }}" width="285" height="396" alt="Art Deco Home"
                    class="img-cover">
                </figure>
            ...
            <li class="colspan-2">
              <div class="hero-card">
                ...
                <figure class="card-banner img-holder" style="--width: 568; --height: 389;">
                  <img src="{{ asset('frontend/assets/images/hero-product-2.jpg') }}" width="568" height="389" alt="Helen Chair"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="hero-card">
                ...
                <figure class="card-banner img-holder" style="--width: 285; --height: 396;">
                  <img src="{{ asset('frontend/assets/images/hero-product-3.jpg') }}" width="285" height="396" alt="Vase Of Flowers"
                    class="img-cover">
                </figure>
            ...
            <li class="colspan-2">
              <div class="hero-card">
                ...
                <figure class="card-banner img-holder" style="--width: 580; --height: 213;">
                  <img src="{{ asset('frontend/assets/images/hero-product-4.jpg') }}" width="580" height="213" alt="Wood Eggs"
                    class="img-cover">
                </figure>
            ...
            <li class="colspan-2">
              <div class="hero-card">
                ...
                <figure class="card-banner img-holder" style="--width: 580; --height: 213;">
                  <img src="{{ asset('frontend/assets/images/hero-product-5.jpg') }}" width="580" height="213" alt="Table Wood Pine"
                    class="img-cover">
                </figure>
        ...
        <div class="container">
          ...
          <div class="about-card">
            <figure class="card-banner img-holder" style="--width: 1170; --height: 450;">
              <img src="{{ asset('frontend/') }}assets/images/about-banner.jpg" width="1170" height="450" loading="lazy" alt="Woodex promo"
                class="img-cover">
            </figure>
          ...
          <ul class="grid-list product-list" data-filter="all">
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-1.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-2.jpg') }}" width="300" height="300" loading="lazy" alt="Art Deco Home"
                    class="img-cover">
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-3.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-4.jpg') }}" width="300" height="300" loading="lazy" alt="Dark Green Jug"
                    class="img-cover">
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-5.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="furniture">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-6.jpg') }}" width="300" height="300" loading="lazy" alt="Helen Chair"
                    class="img-cover">
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-7.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-8.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="furniture">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-9.jpg') }}" width="300" height="300" loading="lazy" alt="Nancy Chair"
                    class="img-cover">
            ...
            <li class="furniture">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-10.jpg') }}" width="300" height="300" loading="lazy" alt="Simple Chair"
                    class="img-cover">
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-11.jpg') }}" width="300" height="300" loading="lazy" alt="Smooth Disk"
                    class="img-cover">
            ...
            <li class="furniture">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-12.jpg') }}" width="300" height="300" loading="lazy" alt="Table Black"
                    class="img-cover">
            ...
            <li class="furniture">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-13.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-14.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-15.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-16.jpg') }}" width="300" height="300" loading="lazy"
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-17.jpg') }}" width="300" height="300" loading="lazy" alt="Wood Eggs"
                    class="img-cover">
            ...
            <li class="decoration">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-18.jpg') }}" width="300" height="300" loading="lazy" alt="Wooden Box"
                    class="img-cover">
            ...
            <li class="accessory">
              <div class="product-card">
                ...
                <a href="#" class="card-banner img-holder has-before" style="--width: 300; --height: 300;">
                  <img src="{{ asset('frontend/assets/images/product-19.jpg') }}" width="300" height="300" loading="lazy" alt="Wooden Cups"
                    class="img-cover">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner img-holder" style="--width: 374; --height: 243;">
                  <img src="{{ asset('frontend/assets/images/blog-1.jpg') }}" width="374" height="243" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner img-holder" style="--width: 374; --height: 243;">
                  <img src="{{ asset('frontend/assets/images/blog-2.jpg') }}" width="374" height="243" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner img-holder" style="--width: 374; --height: 243;">
                  <img src="{{ asset('frontend/assets/images/blog-3.jpg') }}" width="374" height="243" loading="lazy"
