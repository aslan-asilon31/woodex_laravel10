        ...
        @if ($userrole == 1)
            <ul>
                ...
                <li >
                    ...
                    <ul>
                        <li >
                            <a class="{{ $isActive == 'order-list'  ? 'active' : ''}}"  href="">List</a>
                        </li>
                        <li>
                            <a class="{{ $isActive == 'order-detail'  ? 'active' : ''}}" href="">Detail</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>
                            <a class="{{ $isActive }}"  href="">List View</a>
                        </li>
                        <li>
                            <a class="{{ $isActive }}"  href="">Grid View</a>
                        </li>
                        <li>
                            <a class="{{ $isActive }}"  href="">Product Detail</a>
                        </li>
                        <li>
                            <a class="{{ $isActive }}"  href="">Shopping Cart</a>
                        </li>
                        <li>
                            <a class="{{ $isActive }}"  href="">Checkout</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<div class="layout-wrapper">
    ...
    <footer class="content-footer">
        <div><a href="https://nebraskav2.sulaslansetiawan.cfd" target="_blank">Nebraska v2</a> © 2024</div>
    </footer>
    <!-- ./ content-footer -->
